...
int main()
{
    ...
    else if ( discriminant > 0)
    {
      ...
      cout << "The first root is " << setw(10) << x1 << endl;
      cout << "The second root is " << setw(9) << x2 << endl;
    }
    else if ( discriminant == 0 )
    {
      x1 = -b / 2 * a;
      ...
      cout << "The coefficients you have chosen for b is" << setw(5) << b << endl;
      cout << "The coefficients you have chosen for c is" << setw(5) << c << endl;
      cout << "Because the discriminant is 0. So,there is only one root" << x1;
      cout << "The root is " << setw(10) << x1;
    }
    else if ( discriminant < 0 )
    {
      cout << "The coefficients you have chosen for a is" << setw(5) << a << endl;
      cout << "The coefficients you have chosen for b is" << setw(5) << b << endl;
      cout << "The coefficients you have chosen for c is" << setw(5) << c << endl;
      cout << "Because the discriminant is 0, So there is no real root";
    }
}
